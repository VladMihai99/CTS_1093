...
public class Product {
	...
	public final static float MAX_FIDELITY_DISCOUT = 0.15f;
	
	public float getFinalPrice(int productType, float initialPrice, int accountAgeInYears) {
		float finalPrice = 0;
		float fidelityDiscount = (accountAgeInYears > MAX_ACCOUNT_AGE) ? MAX_FIDELITY_DISCOUT : (float) accountAgeInYears / 100;
